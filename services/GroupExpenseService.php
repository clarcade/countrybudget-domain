...
class GroupExpenseService extends ServiceBase
{
...
EOF;
         ...
         echo $ex->getMessage();
         throw new \Exception("Error getting group expense actual data");
      }

      return $group_expense_data;
   }
...
EOF;
         ...
         echo $ex->getMessage();
         throw new \Exception("Error getting group expense item");
      }
...
EOF;
         ...
         if ($mysql_connection->query($sql)) {
            ...
            throw new \Exception("Error adding new expense item");
         }
      } catch (\Exception $ex) {
         echo $ex->getMessage();
         throw new \Exception("Error adding new expense item");
